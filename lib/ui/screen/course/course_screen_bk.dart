...
class CourseScreenbkArgs {
  final CoursesBean coursesBean;

  CourseScreenbkArgs(this.coursesBean);
}

class CourseScreenbk extends StatelessWidget {
  static const routeName = "courseScreenbk";
  final CourseBloc _bloc;

  const CourseScreenbk(this._bloc) : super();

  @override
  Widget build(BuildContext context) {
    final CourseScreenbkArgs args = ModalRoute.of(context).settings.arguments;
    return BlocProvider<CourseBloc>(
        create: (c) => _bloc, child: _CourseScreenbkWidget(args.coursesBean));
  }
}

class _CourseScreenbkWidget extends StatefulWidget {
  final CoursesBean coursesBean;

  const _CourseScreenbkWidget(this.coursesBean);

  @override
  State<StatefulWidget> createState() {
    return _CourseScreenbkWidgetState();
  }
}

class _CourseScreenbkWidgetState extends State<_CourseScreenbkWidget>
